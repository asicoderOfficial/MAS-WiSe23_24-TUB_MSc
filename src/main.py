...
environment = Environment(5, 5, [start_agent, intermediate_agent], [starting_package_point, intermediate_package_point, end_package_point], [starting_obstacle], [starting_package])
