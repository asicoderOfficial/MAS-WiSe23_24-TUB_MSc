...
# Agents
# Create 15 agents
agents = [Waiter(f'naive_greedy{i}', Position(10, 10), [], Perception(3), 'dijkstra', 'naive_greedy', linear_decreasing_time_tips, starting_package_point_pos) for i in range(15)]
